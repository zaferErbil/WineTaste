...
st.write("Access the application's code on my GitHub page [here](https://github.com/zaferErbil/WineTaste)")"Access the application's code on my GitHub page [here](https://github.com/zaferErbil/WineTaste.)")
